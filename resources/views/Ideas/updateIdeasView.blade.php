...
@section('content')
    ...
    <div class="container" style="margin-top:50px;">
        <a href="/ideas"><i class="fa fa-arrow-left" style="font-size:35px; margin-bottom:50px;"></i></a>
        <div class="row">
            <div class="col-9">
                <h1>Editar</h1>
            </div>
        ...
        <div class="container-fluid" style="margin-top:50px;">
            <form method="POST" action='{{route('ideas.update',$idea->id)}}'>
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="tituloTarea" class="form-control" name="titulo" value="{{$idea->titulo}}" id="exampleInputEmail1" aria-describedby="emailHelp" autocomplete="off">
                </div>
                <div class="form-group" style="margin-top:10px;">
                  <label for="descripcion">Descripcion</label>
                  <textarea class="form-control" id="descripcionTarea" name="idea" rows="10">{{$idea->idea}}</textarea>
                </div>
